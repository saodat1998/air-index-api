...
class PollutantsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /* `air`.`pollutants` */
        $pollutants = array(
            array('id' => '1', 'unit_name'=> 'ppb', 'name' => 'O3 (ppb)-8hr', 'calculation_period' => '8hr','formula' => NULL,'note' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '2', 'unit_name'=> 'ppb', 'name' => 'O3 (ppb)-1hr', 'calculation_period' => '1hr','formula' => NULL,'note' => NULL,'created_at' => NULL,'updated_at' => NULL),
