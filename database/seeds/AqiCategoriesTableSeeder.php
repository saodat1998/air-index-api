    ...
    public function run()
    {
        ...
        /* `air`.`aqi_categories` */
                    $aqi_categories = array(
                        array('id' => '1','name' => 'Good','min' => '0.00','max' => '50.00','health_implications' => 'No health implications.	','recommendation' => 'Everyone can continue their outdoor activities normally.','description' => 'Minimal impact','created_at' => NULL,'updated_at' => NULL,'color' => '#00e400'),
